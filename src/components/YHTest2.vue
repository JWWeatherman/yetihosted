  ...
  <div>
    ...
    <div class="container" style="margin-top: 3rem;">
      ...
      <ol>
        ...
        <li>Click <b>Recover Wallet</b> and follow the steps until you have tested sending and receiving a small amount of bitcoin using your freshly restored wallet.</li>
