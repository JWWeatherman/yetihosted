<template>
  <div>
    ...
    <div class="container" style="margin-top: 3rem;">
      ...
      <ol>
        <li>Set aside 3 "Seed" CDs labled "Seed 1", "Seed 2", and "Seed 3".</li>
        ...
        <li>When you see the guide for sending and reciving follow all the steps to confirm you sucsessfuly restored your wallet.</li>
        <li>Repeat steps 2 through 4 with the "Seed" CDs labled "Seed4", "Seed5", and "Seed6".</li>
