<template>
    <div class="container" style="margin-top: 3rem;">
      ...
      <div class="hero-unit">
          ...
          <p>
            <input v-on:click="start" style="margin-bottom:50px;" class="btn btn-primary btn-large" type="submit" id="next" value="Learn more">
          </p>
      </div>
      <div class="hero-unit">
          ...
          <p>
            <input v-on:click="recover" style="margin-bottom:50px;" class="btn btn-primary btn-large" type="submit" id="next" value="Learn more">
          </p>
      </div>
    </div>
</template>
