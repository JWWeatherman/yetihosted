  ...
  <div>
    ...
    <div class="container" style="margin-top: 3rem;">
      ...
      <ol>
        ...
        <li>Click <b>Copy</b> to copy the text below this line.</li>
          <div style="width:75%;" class="input-group mb-3 mt-3">
            <input v-on:click="copy2" v-b-tooltip.click v-b-tooltip.blur title="Copied" readonly type="text" class="form-control" aria-label="Default" id="copy2" aria-describedby="inputGroup-sizing-default" value="python3 ~/yeticold/initialize.py YetiLevelThreeSecondaryCreate">
            <div class="input-group-append">
