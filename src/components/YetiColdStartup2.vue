<template>
  <div>
    ...
    <div class="container" style="margin-top: 3rem;">
      ...
      <ul>
          <li>Use the Long Term Support (LTS) Version of Ubuntu. This is currently 20.04 and is at the top of the download page. We can not garantie that yeticold will work with any other ubuntu version.</li>
          ...
          <li>Using a marker label one laptop <b>Primary</b> and the other laptop <b>Secondary</b>. The primary laptop will be a receive only device and the secondary laptop will handle private keys.</li>
      </ul>
