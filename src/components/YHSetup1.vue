  ...
  <div>
    ...
    <div class="container" style="margin-top: 3rem;">
      ...
      <p>Gather the following items and then click <b>Next</b>.</p>
        <ul>
        <li>A that can run Ubuntu and Bitcoin Core. Almost any laptop made for Windows will work, but if your laptop has an SSD type hard drive some steps will take a few hours instead of a few days. Laptops without SSD type drives cost about $150 USD and laptops with SSD drives cost about $200 USD. You can also buy a new laptop from a store like Amazon or Walmart and return it when you are finished with setup because your bitcoin will be stored on paper and CD-ROM disks.</li>
